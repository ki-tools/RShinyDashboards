...
sidebar <- dashboardSidebar(
  ...
  radioButtons('variable', label = "Cases or Deaths?", choices = c("Number of Deaths" = "deaths", "Number of Cases" = "cases1000")),
...
server <- function(input, output) { 
  ...
  observeEvent(input$load, {
    ...
    nyt(fulldata) # This reactive item now has is composed of the NYT COVID-19 data.
